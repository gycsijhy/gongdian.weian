...
#endif
@implementation n_webservice_uf_get_person_info
- (id)init
{
	if((self = [super init])) {
		sfzh = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.sfzh != 0) {
		xmlAddChild(node, [self.sfzh xmlNodeForDoc:node->doc elementName:@"sfzh" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize sfzh;
...
{
	n_webservice_uf_get_person_info *newObject = [[n_webservice_uf_get_person_info new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "sfzh")) {
...
@end
@implementation n_webservice_uf_get_person_infoResponse
- (id)init
{
	if((self = [super init])) {
		uf_get_person_infoResult = 0;
	}
...
- (void)dealloc
{
	if(uf_get_person_infoResult != nil) [uf_get_person_infoResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.uf_get_person_infoResult != 0) {
		xmlAddChild(node, [self.uf_get_person_infoResult xmlNodeForDoc:node->doc elementName:@"uf_get_person_infoResult" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize uf_get_person_infoResult;
/* attributes */
- (NSDictionary *)attributes
{
	NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
	n_webservice_uf_get_person_infoResponse *newObject = [[n_webservice_uf_get_person_infoResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "uf_get_person_infoResult")) {
				...
				self.uf_get_person_infoResult = newChild;
			}
		}
	}
}
@end
@implementation n_webservice_u_getdata_for_sql
- (id)init
{
	if((self = [super init])) {
		as_sql = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.as_sql != 0) {
		xmlAddChild(node, [self.as_sql xmlNodeForDoc:node->doc elementName:@"as_sql" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize as_sql;
...
{
	n_webservice_u_getdata_for_sql *newObject = [[n_webservice_u_getdata_for_sql new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "as_sql")) {
				...
				self.as_sql = newChild;
			}
		}
	}
}
@end
@implementation n_webservice_u_getdata_for_sqlResponse
- (id)init
{
	if((self = [super init])) {
		u_getdata_for_sqlResult = 0;
	}
...
- (void)dealloc
{
	if(u_getdata_for_sqlResult != nil) [u_getdata_for_sqlResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.u_getdata_for_sqlResult != 0) {
		xmlAddChild(node, [self.u_getdata_for_sqlResult xmlNodeForDoc:node->doc elementName:@"u_getdata_for_sqlResult" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize u_getdata_for_sqlResult;
/* attributes */
- (NSDictionary *)attributes
{
	NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
	n_webservice_u_getdata_for_sqlResponse *newObject = [[n_webservice_u_getdata_for_sqlResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "u_getdata_for_sqlResult")) {
				...
				self.u_getdata_for_sqlResult = newChild;
			}
		}
	}
}
@end
@implementation n_webservice_uf_get_person_photo
- (id)init
{
	if((self = [super init])) {
		sfzh = 0;
...
{
	n_webservice_uf_get_person_photo *newObject = [[n_webservice_uf_get_person_photo new] autorelease];
...
@end
@implementation n_webservice_uf_get_person_photoResponse
- (id)init
{
	if((self = [super init])) {
		uf_get_person_photoResult = 0;
	}
...
- (void)dealloc
{
	if(uf_get_person_photoResult != nil) [uf_get_person_photoResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.uf_get_person_photoResult != 0) {
		xmlAddChild(node, [self.uf_get_person_photoResult xmlNodeForDoc:node->doc elementName:@"uf_get_person_photoResult" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize uf_get_person_photoResult;
/* attributes */
- (NSDictionary *)attributes
{
	NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
	n_webservice_uf_get_person_photoResponse *newObject = [[n_webservice_uf_get_person_photoResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "uf_get_person_photoResult")) {
				...
				self.uf_get_person_photoResult = newChild;
			}
		}
	}
}
@end
@implementation n_webservice_checkpassword
- (id)init
{
	if((self = [super init])) {
		userid = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.password != 0) {
		xmlAddChild(node, [self.password xmlNodeForDoc:node->doc elementName:@"password" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize userid;
...
{
	n_webservice_checkpassword *newObject = [[n_webservice_checkpassword new] autorelease];
...
@end
@implementation n_webservice_checkpasswordResponse
- (id)init
{
	if((self = [super init])) {
...
- (void)dealloc
{
	if(checkpasswordResult != nil) [checkpasswordResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.checkpasswordResult != 0) {
		xmlAddChild(node, [self.checkpasswordResult xmlNodeForDoc:node->doc elementName:@"checkpasswordResult" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize checkpasswordResult;
/* attributes */
- (NSDictionary *)attributes
{
	NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
	n_webservice_checkpasswordResponse *newObject = [[n_webservice_checkpasswordResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "checkpasswordResult")) {
				...
				self.checkpasswordResult = newChild;
			}
		}
	}
}
...
@end
@implementation n_webservice_uf_regiest
- (id)init
{
	if((self = [super init])) {
		username = 0;
...
- (void)dealloc
{
	...
	if(password != nil) [password release];
	if(xingming != nil) [xingming release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.username != 0) {
		xmlAddChild(node, [self.username xmlNodeForDoc:node->doc elementName:@"username" elementNSPrefix:@"n_webservice"]);
	}
	if(self.password != 0) {
		xmlAddChild(node, [self.password xmlNodeForDoc:node->doc elementName:@"password" elementNSPrefix:@"n_webservice"]);
	}
	if(self.xingming != 0) {
		xmlAddChild(node, [self.xingming xmlNodeForDoc:node->doc elementName:@"xingming" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize username;
...
{
	n_webservice_uf_regiest *newObject = [[n_webservice_uf_regiest new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "xingming")) {
				...
				self.xingming = newChild;
			}
		}
	}
}
@end
@implementation n_webservice_uf_regiestResponse
- (id)init
{
	if((self = [super init])) {
		uf_regiestResult = 0;
...
- (void)dealloc
{
	if(uf_regiestResult != nil) [uf_regiestResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.uf_regiestResult != 0) {
		xmlAddChild(node, [self.uf_regiestResult xmlNodeForDoc:node->doc elementName:@"uf_regiestResult" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize uf_regiestResult;
/* attributes */
- (NSDictionary *)attributes
{
	NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
	n_webservice_uf_regiestResponse *newObject = [[n_webservice_uf_regiestResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "uf_regiestResult")) {
				...
				self.uf_regiestResult = newChild;
			}
		}
	}
}
...
@end
@implementation n_webservice_get_person_info_json
- (id)init
{
	if((self = [super init])) {
		sfzh = 0;
...
{
	n_webservice_get_person_info_json *newObject = [[n_webservice_get_person_info_json new] autorelease];
...
@end
@implementation n_webservice_get_person_info_jsonResponse
- (id)init
{
	if((self = [super init])) {
		get_person_info_jsonResult = 0;
	}
...
- (void)dealloc
{
	if(get_person_info_jsonResult != nil) [get_person_info_jsonResult release];
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.get_person_info_jsonResult != 0) {
		xmlAddChild(node, [self.get_person_info_jsonResult xmlNodeForDoc:node->doc elementName:@"get_person_info_jsonResult" elementNSPrefix:@"n_webservice"]);
	}
}
/* elements */
@synthesize get_person_info_jsonResult;
/* attributes */
- (NSDictionary *)attributes
{
	NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
...
{
	n_webservice_get_person_info_jsonResponse *newObject = [[n_webservice_get_person_info_jsonResponse new] autorelease];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
	...
	for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
		if(cur->type == XML_ELEMENT_NODE) {
			...
			if(xmlStrEqual(cur->name, (const xmlChar *) "get_person_info_jsonResult")) {
				...
				self.get_person_info_jsonResult = newChild;
			}
		}
	}
}
...
{
	return [self performSynchronousOperation:[[(n_webserviceSoapBinding_uf_get_person_info*)[n_webserviceSoapBinding_uf_get_person_info alloc] initWithBinding:self delegate:self
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoapBinding_uf_get_person_info*)[n_webserviceSoapBinding_uf_get_person_info alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
- (n_webserviceSoapBindingResponse *)u_getdata_for_sqlUsingParameters:(n_webservice_u_getdata_for_sql *)aParameters 
{
	return [self performSynchronousOperation:[[(n_webserviceSoapBinding_u_getdata_for_sql*)[n_webserviceSoapBinding_u_getdata_for_sql alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoapBinding_u_getdata_for_sql*)[n_webserviceSoapBinding_u_getdata_for_sql alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
- (n_webserviceSoapBindingResponse *)uf_get_person_photoUsingParameters:(n_webservice_uf_get_person_photo *)aParameters 
{
	return [self performSynchronousOperation:[[(n_webserviceSoapBinding_uf_get_person_photo*)[n_webserviceSoapBinding_uf_get_person_photo alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoapBinding_uf_get_person_photo*)[n_webserviceSoapBinding_uf_get_person_photo alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
- (n_webserviceSoapBindingResponse *)checkpasswordUsingParameters:(n_webservice_checkpassword *)aParameters 
{
	return [self performSynchronousOperation:[[(n_webserviceSoapBinding_checkpassword*)[n_webserviceSoapBinding_checkpassword alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoapBinding_checkpassword*)[n_webserviceSoapBinding_checkpassword alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
...
{
	return [self performSynchronousOperation:[[(n_webserviceSoapBinding_uf_regiest*)[n_webserviceSoapBinding_uf_regiest alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoapBinding_uf_regiest*)[n_webserviceSoapBinding_uf_regiest alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
...
{
	return [self performSynchronousOperation:[[(n_webserviceSoapBinding_get_person_info_json*)[n_webserviceSoapBinding_get_person_info_json alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoapBinding_get_person_info_json*)[n_webserviceSoapBinding_get_person_info_json alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
...
@end
@implementation n_webserviceSoapBinding_uf_get_person_info
...
- (void)main
{
	...
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"uf_get_person_info"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
	
	[binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://gyyb.com/uf_get_person_info" forOperation:self];
}
				...
				if(cur->type == XML_ELEMENT_NODE) {
					...
					if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "uf_get_person_infoResponse")) {
									n_webservice_uf_get_person_infoResponse *bodyObject = [n_webservice_uf_get_person_infoResponse deserializeNode:bodyNode];
...
@end
@implementation n_webserviceSoapBinding_u_getdata_for_sql
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoapBinding *)aBinding delegate:(id<n_webserviceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"u_getdata_for_sql"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
	
	[binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://gyyb.com/u_getdata_for_sql" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	if (responseData != nil && delegate != nil)
			...
			for( ; cur != NULL ; cur = cur->next) {
				if(cur->type == XML_ELEMENT_NODE) {
					...
					if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "u_getdata_for_sqlResponse")) {
									n_webservice_u_getdata_for_sqlResponse *bodyObject = [n_webservice_u_getdata_for_sqlResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation n_webserviceSoapBinding_uf_get_person_photo
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoapBinding *)aBinding delegate:(id<n_webserviceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"uf_get_person_photo"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
	
	[binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://gyyb.com/uf_get_person_photo" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	if (responseData != nil && delegate != nil)
			...
			for( ; cur != NULL ; cur = cur->next) {
				if(cur->type == XML_ELEMENT_NODE) {
					...
					if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "uf_get_person_photoResponse")) {
									n_webservice_uf_get_person_photoResponse *bodyObject = [n_webservice_uf_get_person_photoResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation n_webserviceSoapBinding_checkpassword
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoapBinding *)aBinding delegate:(id<n_webserviceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"checkpassword"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
	
	[binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://gyyb.com/checkpassword" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	if (responseData != nil && delegate != nil)
			...
			for( ; cur != NULL ; cur = cur->next) {
				if(cur->type == XML_ELEMENT_NODE) {
					...
					if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "checkpasswordResponse")) {
									n_webservice_checkpasswordResponse *bodyObject = [n_webservice_checkpasswordResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation n_webserviceSoapBinding_uf_regiest
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoapBinding *)aBinding delegate:(id<n_webserviceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"uf_regiest"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
	
	[binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://gyyb.com/uf_regiest" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	if (responseData != nil && delegate != nil)
			...
			for( ; cur != NULL ; cur = cur->next) {
				if(cur->type == XML_ELEMENT_NODE) {
					...
					if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "uf_regiestResponse")) {
									n_webservice_uf_regiestResponse *bodyObject = [n_webservice_uf_regiestResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation n_webserviceSoapBinding_get_person_info_json
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoapBinding *)aBinding delegate:(id<n_webserviceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"get_person_info_json"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
	
	[binding sendHTTPCallUsingBody:operationXMLString soapAction:@"http://gyyb.com/get_person_info_json" forOperation:self];
}
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	if (responseData != nil && delegate != nil)
			...
			for( ; cur != NULL ; cur = cur->next) {
				if(cur->type == XML_ELEMENT_NODE) {
					...
					if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "get_person_info_jsonResponse")) {
									n_webservice_get_person_info_jsonResponse *bodyObject = [n_webservice_get_person_info_jsonResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
{
	return [self performSynchronousOperation:[[(n_webserviceSoap12Binding_uf_get_person_info*)[n_webserviceSoap12Binding_uf_get_person_info alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoap12Binding_uf_get_person_info*)[n_webserviceSoap12Binding_uf_get_person_info alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
- (n_webserviceSoap12BindingResponse *)u_getdata_for_sqlUsingParameters:(n_webservice_u_getdata_for_sql *)aParameters 
{
	return [self performSynchronousOperation:[[(n_webserviceSoap12Binding_u_getdata_for_sql*)[n_webserviceSoap12Binding_u_getdata_for_sql alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoap12Binding_u_getdata_for_sql*)[n_webserviceSoap12Binding_u_getdata_for_sql alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
- (n_webserviceSoap12BindingResponse *)uf_get_person_photoUsingParameters:(n_webservice_uf_get_person_photo *)aParameters 
{
	return [self performSynchronousOperation:[[(n_webserviceSoap12Binding_uf_get_person_photo*)[n_webserviceSoap12Binding_uf_get_person_photo alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoap12Binding_uf_get_person_photo*)[n_webserviceSoap12Binding_uf_get_person_photo alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
- (n_webserviceSoap12BindingResponse *)checkpasswordUsingParameters:(n_webservice_checkpassword *)aParameters 
{
	return [self performSynchronousOperation:[[(n_webserviceSoap12Binding_checkpassword*)[n_webserviceSoap12Binding_checkpassword alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoap12Binding_checkpassword*)[n_webserviceSoap12Binding_checkpassword alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
...
{
	return [self performSynchronousOperation:[[(n_webserviceSoap12Binding_uf_regiest*)[n_webserviceSoap12Binding_uf_regiest alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoap12Binding_uf_regiest*)[n_webserviceSoap12Binding_uf_regiest alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
...
{
	return [self performSynchronousOperation:[[(n_webserviceSoap12Binding_get_person_info_json*)[n_webserviceSoap12Binding_get_person_info_json alloc] initWithBinding:self delegate:self
																							parameters:aParameters
																							] autorelease]];
}
...
{
	[self performAsynchronousOperation: [[(n_webserviceSoap12Binding_get_person_info_json*)[n_webserviceSoap12Binding_get_person_info_json alloc] initWithBinding:self delegate:responseDelegate
																							 parameters:aParameters
																							 ] autorelease]];
}
...
@end
@implementation n_webserviceSoap12Binding_uf_get_person_info
@synthesize parameters;
...
@end
@implementation n_webserviceSoap12Binding_u_getdata_for_sql
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoap12Binding *)aBinding delegate:(id<n_webserviceSoap12BindingResponseDelegate>)responseDelegate
parameters:(n_webservice_u_getdata_for_sql *)aParameters
{
...
@end
@implementation n_webserviceSoap12Binding_uf_get_person_photo
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoap12Binding *)aBinding delegate:(id<n_webserviceSoap12BindingResponseDelegate>)responseDelegate
parameters:(n_webservice_uf_get_person_photo *)aParameters
{
...
@end
@implementation n_webserviceSoap12Binding_checkpassword
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoap12Binding *)aBinding delegate:(id<n_webserviceSoap12BindingResponseDelegate>)responseDelegate
parameters:(n_webservice_checkpassword *)aParameters
{
...
@end
@implementation n_webserviceSoap12Binding_uf_regiest
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoap12Binding *)aBinding delegate:(id<n_webserviceSoap12BindingResponseDelegate>)responseDelegate
parameters:(n_webservice_uf_regiest *)aParameters
{
...
@end
@implementation n_webserviceSoap12Binding_get_person_info_json
@synthesize parameters;
- (id)initWithBinding:(n_webserviceSoap12Binding *)aBinding delegate:(id<n_webserviceSoap12BindingResponseDelegate>)responseDelegate
parameters:(n_webservice_get_person_info_json *)aParameters
{
